...

{
...

    {
...

                {
                    ...
                    case 3:
...

                        {
                            ...
                            if (_delete <= count_dos)

                            {

                                RemoveMas(ref fio, _delete, ref count_dos, ref post, ref post_count);
        ...
        static void RemoveMas(ref string[,] _fio, int _delete1, ref int count_dos, ref string[] _post, ref int _post_count)
